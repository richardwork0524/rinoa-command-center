...
export function EmptyState({ message }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6">
      <div className="w-14 h-14 rounded-full bg-surface-2 border border-border-light flex items-center justify-center mb-4">
      ...
      <p className="text-[14px] text-text-3 text-center">{message}</p>
    </div>
  );
}
