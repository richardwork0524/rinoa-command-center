...
export function EmptyState({ message }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6">
      <div className="w-14 h-14 rounded-full bg-[var(--card)] border border-[var(--border2)] flex items-center justify-center mb-4">
      ...
      <p className="text-[14px] text-[var(--text3)] text-center">{message}</p>
    </div>
  );
}
